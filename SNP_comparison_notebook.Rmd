...
dir_name <- (getwd() %>% str_split( "/" ))[[1]] %>% tail( 1 )
ref_name <- dir( pattern = "*.fasta" )
nwk_name <- dir( pattern = "*.newick" )
...
### This analysis name -- ``r dir_name ``

### Using reference -- ``r ref_name `` 

### Using tree -- ``r nwk_name ``
