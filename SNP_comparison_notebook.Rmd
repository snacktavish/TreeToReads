...
# closest_match <- cbind( sim_loci, sim_loci[ J( det_loci ), roll = "nearest"])
# 
# sim_loci[ J( det_loci ), roll = "nearest"]
# 
# CoordTable <- sim_loci %>% rename( sim_coord="." ) %>% mutate( best_match=det_loci[ J( sim_loci ), roll = "nearest"]$. )
# 
# 
